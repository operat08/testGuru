...
users = User.create!([{ name: 'Vasiliy', email: 'io@ya.eu', password_digest: 'sad' }, { name: 'Fedor', email: 'jj@hh.ru', password_digest: 'sad' }, { name: 'Jack', email: 'res@g.com', password_digest: 'asd' }])
